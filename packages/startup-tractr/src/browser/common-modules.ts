...
import { CloudStaticResourceModule, S3BrowserModule } from '@opensumi/ide-cloud-storage/lib/browser';
...
import { MultimediaViewerModule } from '@opensumi/ide-multimedia-viewer/lib/browser';
...
export const CommonBrowserModules: ConstructorOf<BrowserModule>[] = [
  ...
  // Tractr custom modules
  MultimediaViewerModule,
  S3BrowserModule,
  CloudStaticResourceModule,
];
